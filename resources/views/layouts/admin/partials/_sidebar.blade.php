            ...
            <div class="navbar-vertical-footer-offset">
                ...
                <div class="navbar-vertical-content">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        <li
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="nav-item {{Request::is('admin/table/order/list/canceled')?'active':''}}">
                                    <a class="nav-link " href="{{route('admin.table.order.list',['canceled'])}}"
                                        title="">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate sidebar--badge-container">
                                            {{translate('canceled')}}
                                ...
                                <li class="nav-item {{Request::is('admin/table/order/running')?'active':''}}">
                                    <a class="nav-link " href="{{route('admin.table.order.running')}}" title="">
                                        ...
                                        <span class="text-truncate sidebar--badge-container">
                                            {{translate('on_table')}}
                                            <span class="badge badge-soft-success badge-pill ml-1">
                                                {{\App\Model\Order::with('table_order')->whereHas('table_order',
                                                function($q){
                        ...
                        <li class="nav-item">
                            <small class="nav-subtitle" title="Layouts">{{translate('Help_&_Support_Section')}}</small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                        </li>
                        <!-- MESSAGE -->
                    ...
                    <li
                        ...
                        <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:">
                            ...
                            <span
                                class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{translate('Page
                                & Media')}}</span>
                        </a>
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                        ...
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                            ...
                            <li
                                ...
                                <a class="nav-link" href="{{route('admin.business-settings.web-app.payment-method')}}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{translate('3rd
                                        Party Configurations')}}</span>
                                </a>
                            </li>
                            ...
                            <li
                                ...
                                <a class="nav-link"
                                    ...
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{translate('Offline
                                        Payment Method')}}</span>
                                </a>
                            </li>
                            ...
                            <li
                                ...
                                <a class="nav-link"
                                    ...
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{translate('Firebase
                                        Notification')}}</span>
                                </a>
                            </li>
                        </ul>
                    ...
                    <li
                        ...
                        <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:">
                            <i class="tio-running nav-icon"></i>
                            <span
                                class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{translate('Zone')}}</span>
                        </a>
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                            style="display: {{Request::is('admin/business-settings/web-app/third-party*')?'block':'none'}}">
                            <!-- Page Setup -->
                            ...
                            <li
                                ...
                                <a class="nav-link" href="{{route('admin.zone-list')}}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{translate('Country')}}</span>
                                </a>
                            </li>
                    ...
                    <li
                        ...
                        <a class="js-navbar-vertical-aside-menu-link nav-link"
                            ...
                            <span
                                class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{translate('System
                                Setup')}}</span>
                        </a>
                    </li>

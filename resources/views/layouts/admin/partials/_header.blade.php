                                        ...
                                        <li>
                                            <a class="dropdown-item pr-8 d-flex gap-2 align-items-center"
                                                ...
                                                {{--<img class="avatar-img rounded-0"
                                                    src="{{asset('public/assets/admin/img/flag.png')}}"
                        ...
                        <div class="hs-unfold">
                            <a class="js-hs-unfold-invoker navbar-dropdown-account-wrapper media gap-2"
                                ...
                                <div class="media-body d-flex align-items-end flex-column">
                                    ...
                                    <span
                                        class="card-text fz-12 font-weight-bold">{{auth('admin')->user()->role->name}}</span>
                                </div>
                            ...
                            <div id="accountNavbarDropdown"
                                ...
                                <a class="dropdown-item" href="javascript:" onclick="Swal.fire({
                                    title: '{{translate(" Do you want to logout?")}}', showDenyButton: true,
                                    showCancelButton: true, confirmButtonColor: '#FC6A57' , cancelButtonColor: '#363636'
                                    , confirmButtonText: '{{translate("Yes")}}' , cancelButtonText:
                                    `{{translate('No')}}`, }).then((result)=> {
                                    if (result.value) {

    ...
    <div class="">
        <div class="text-center">
            ...
            <div class="btn--container justify-content-end my-2 mx-3">
                ...
                <a type="reset" class="btn btn-secondary" onclick="verify_offline_payment({{ $order['id'] }}, 2)">{{
                    translate('Payment_Did_Not_Received') }}</a>
                @endif
                <a type="submit" class="btn btn-primary" onclick="verify_offline_payment({{ $order['id'] }}, 1)">{{
                    translate('Yes') }}, {{ translate('Payment_Received') }}</a>
            </div>
